...
import com.example.consultoriodentaldoctor.databinding.ActivityMainActivity2InicioseccionpantBinding
...
class MainActivity2_inicioseccionpant : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnmiscitas= findViewById<Button>(R.id.btnmiscitas) as Button
        val btnsalir= findViewById<Button>(R.id.btnsalir) as Button


        btnmiscitas.setOnClickListener() {
            val intent = Intent(this@MainActivity2_inicioseccionpant, MainActivity2_miscitaspant::class.java)
